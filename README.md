...
See [Casper Delegation/staking FAQ](https://github.com/mabahma/CasperDelegate/blob/main/FAQ.md).
...
## Undelegate
* You can undelegate your all or part of your tokens by runing thios script:  `./undelegate.sh`
