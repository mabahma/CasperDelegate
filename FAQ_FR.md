Délégation Casper / FAQ sur le staking

Il s'agit d'une collection de questions et réponses fournies par la communauté aux questions fréquemment posées sur le processus de délégation / staking du réseau Casper. 
...
Y a-t-il une période de refroidissement ( cool-down) / verrouillage après la délégation?
Bien qu'il y ait un délai avant que vous puissiez accéder à vos jetons précédemment délégués, il n'y a pas de période de refroidissement ou de verrouillage après la délégation
 de jetons. Vous pouvez annuler la délégation de n'importe quel nombre de jetons à tout moment. Lors de la non-délégation des jetons d'un validateur, le réseau met les fonds en 
 attente pendant 7 époques, environ 14 heures, puis renvoie automatiquement les jetons CSPR sur votre compte.
 
 Y a-t-il du slashing? Puis-je perdre mes jetons délégués?
...
Quel est le coût de la délégation et de la non-délégation?
...
Quel est le taux de récompense annuel des jetons délégués?
...
Comment puis-je déléguer mes jetons?
